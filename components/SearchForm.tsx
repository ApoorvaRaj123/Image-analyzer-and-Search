...
const SearchForm = () => {
  ...
  return (
    <form
      onSubmit={onSubmit}
      className="items-center justify-center h-[30vh] flex flex-col  w-full"
    >
      <div className="items-center justify-center h-screen flex flex-col absolute w-full z-30 mb-2">
        <h1 className="text-6xl items-center">Image Search</h1>
        <div className="flex mt-9 hover:shadow-lg dark:bg-[#303134] hover:bg-[#FFFFFF] focus-within:shadow-lg rounded-full border border-gray-200 dark:border-none px-5 py-3 items-center w-full max-w-md sm:max-w-xl lg:max-w-2xl">
          {/* fileupload => lens */}
          <div
            className={` ${showUploadModal ? "block shadow-2xl" : "hidden"} `}
          >
